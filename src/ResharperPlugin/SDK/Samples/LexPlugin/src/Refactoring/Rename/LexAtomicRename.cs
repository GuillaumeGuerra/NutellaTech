...
{
  internal class LexAtomicRename : AtomicRenameBase
  {
    ...
    public LexAtomicRename(IDeclaredElement declaredElement, [NotNull] string newName, bool doNotShowBindingConflicts)
    {
