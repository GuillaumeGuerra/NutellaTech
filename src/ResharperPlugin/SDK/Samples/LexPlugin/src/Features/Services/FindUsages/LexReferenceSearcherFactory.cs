...
{
  [PsiSharedComponent]
  internal class LexReferenceSearcherFactory : IDomainSpecificSearcherFactory
  {
    ...
    {
      return new LexReferenceSearcher(this, elements, false);
    }
    ...
    {
      return new LexReferenceSearcher(this, elements, true);
    }
    ...
    {
      return new ConstantExpressionDomainSpecificSearcher<LexLanguage>(constantValue, onlyLiteralExpression);
    }
